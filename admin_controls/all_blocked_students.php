...
$page_name = " - جميع المستخدمين المحظورين";
include "init.php";
        ...
        <div class="allContent">
                    ...
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">جميع المستخدمين المحظورين</li>
                        </ol>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th>حالة الهاتف</th>             
                                            <th>حظر المستخدم</th>
                                            <th style="direction: rtl;"> IPS حذف ال </th>                         
                                        </tr>
                                    </thead>
                                    <tfoot>
                                        <tr>
                                        ...
                                        <tbody>
                                           ...
                                           foreach($students as $all_students){
                                            echo"<tr>";
                                                ...
                                                if($all_students['email_verified_at'] == 1){
                                                ...
                                                if($all_students['phone_verified_at'] == 1){
                                                    echo '<td><div class="ui green label"><i style="font-size:15px" class="fas fa-check-circle"></i> Verified</div></td>';}else{echo '<td><div class="ui yellow label"><i style="font-size:15px" class="fad fa-hourglass-end"></i> non-Verified</div></td>';
                                                }
                                                ...
                                                echo "<td>
                                                <button style='" . $block_state . "' student-id=" . $all_students['id'] . "
                                                class='btn blockbtn blockbtn_" . $all_students['id'] . " btn-danger m-2'>حظر<i class='bx bxs-user-minus m-1'></i></button> 
                                                
                                                <button style='" . $un_block_state . "' student-id=" . $all_students['id'] . "
                                                class='btn unblock unblock_" . $all_students['id'] . " btn-primary m-2'>الغاء الحظر<i class='bx bxs-user-minus m-1'></i></button>
                                                ...
                                                echo "<td>
                                                <button student-id-for-IPS='".$all_students['id']."'
                                                class='btn deleteipsbtn btn-danger belete_btn m-2'>حذف الاجهزه<i class='bx bxs-user-minus m-1'></i></button> " . "</td>";
