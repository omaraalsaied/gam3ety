<?php 
    ...
    require "init.php";
        ...
        if(empty( $_GET["course"]) || empty($_GET["year"]) || empty($_GET["subject"])){
            echo "
            <script>
...
<section class="courses">
    <div class="overlay">
        <div class="container">
            <div class="courses_header">اختار <strong style="color:#E20813;font-family: 'Cairo', sans-serif;">القسم .<img class="under_line" src="img/line under word.webp" alt="vector"></strong></ي>
                <div class="row" style="direction: rtl;">
                    <?php 
                    if(empty($dep)){?>
                        <p style="margin-top: 20px;font-weight: 700;font-size: 30px;" class="text-danger text-center">* عفوا .. لاتوجد اقسام مسجله لهذا الكورس بعد , من فضلك تواصل مع مسئولين الموقع *</p>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="video_item">
                            ...
                            <div class="item_header">
                                <img src="admin_controls/img/departments/<?php echo  $dep_data["img"] ?>" alt="video image">
                            </div>
                            <div class="video_content">
                                <h3 class="text-center mb-3"><?php echo  $dep_data["dep_name"] ?></h3>
                                <p class="subject"><?php echo $year . " - " . $subject; ?></p>
                                <p class="desc">
                                   اختر القسم وسوف تجد جميع المحاضرات الخاصه به بداخله
                                </p>
                                <div class="video_statistics">
                                    <div class="row">
                                        <div class="col-12">
                                            <img src="img/courses page/time.png" alt="icon 1">
                                            <p><?php $date = explode(" . " , $dep_data["created_at"]);echo $date[0]; ?></p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <button style="line-height: 18px !important;" class="videos_btn"><a style="color:#fff" href="courses_videos.php?course=<?php echo $course . "&year=" . $year . "&subject=" . $subject . "&department=" . $dep_data["id"];?>">انتقل الي المحاضرات</a></button>
                                    </div>
                                </div>
